...
fn canonicalizeTransformedExtension(arena: std.mem.Allocator, subtags: [][]const u8) !?[][]const u8 {
    ...
    if (has_tlang) {
        ...
        // Unlike a top-level language id, the whole `-t-` sequence is lowercase
        // in canonical form ("en-t-en-latn", not "en-t-en-Latn").
        for (try emitLanguageId(arena, tlang)) |sub| try out.append(arena, try lower(arena, sub));
    }
    var keys = std.ArrayListUnmanaged([]const u8){};
    var values = std.ArrayListUnmanaged([][]const u8){};
    while (idx < subtags.len) {
...
pub fn canonicalize(arena: std.mem.Allocator, tag: []const u8) !?[]const u8 {
    ...
    // A regular grandfathered tag may still carry variants/extensions
    // ("art-lojban-fonipa"), so the mapping matches on the subtag prefix.
...
/// CLDR maps every ISO 3166-1 numeric territory code to its alpha-2 spelling
/// (`en-554` canonicalizes to `en-NZ`). Deprecated numeric codes whose
/// replacement is not a plain alpha-2 code are listed above instead.
const numeric_regions = [_][2][]const u8{
    .{ "004", "AF" }, .{ "008", "AL" }, .{ "010", "AQ" }, .{ "012", "DZ" }, .{ "016", "AS" },
    .{ "020", "AD" }, .{ "024", "AO" }, .{ "028", "AG" }, .{ "031", "AZ" }, .{ "032", "AR" },
    .{ "036", "AU" }, .{ "040", "AT" }, .{ "044", "BS" }, .{ "048", "BH" }, .{ "050", "BD" },
    .{ "051", "AM" }, .{ "052", "BB" }, .{ "056", "BE" }, .{ "060", "BM" }, .{ "062", "034" },
    .{ "064", "BT" }, .{ "068", "BO" }, .{ "070", "BA" }, .{ "072", "BW" }, .{ "074", "BV" },
    .{ "076", "BR" }, .{ "084", "BZ" }, .{ "086", "IO" }, .{ "090", "SB" }, .{ "092", "VG" },
    .{ "096", "BN" }, .{ "100", "BG" }, .{ "104", "MM" }, .{ "108", "BI" }, .{ "112", "BY" },
    .{ "116", "KH" }, .{ "120", "CM" }, .{ "124", "CA" }, .{ "132", "CV" }, .{ "136", "KY" },
    .{ "140", "CF" }, .{ "144", "LK" }, .{ "148", "TD" }, .{ "152", "CL" }, .{ "156", "CN" },
    .{ "158", "TW" }, .{ "162", "CX" }, .{ "166", "CC" }, .{ "170", "CO" }, .{ "172", "RU" },
    .{ "174", "KM" }, .{ "175", "YT" }, .{ "178", "CG" }, .{ "180", "CD" }, .{ "184", "CK" },
    .{ "188", "CR" }, .{ "191", "HR" }, .{ "192", "CU" }, .{ "196", "CY" }, .{ "200", "CZ" },
    .{ "203", "CZ" }, .{ "204", "BJ" }, .{ "208", "DK" }, .{ "212", "DM" }, .{ "214", "DO" },
    .{ "218", "EC" }, .{ "222", "SV" }, .{ "226", "GQ" }, .{ "230", "ET" }, .{ "231", "ET" },
    .{ "232", "ER" }, .{ "233", "EE" }, .{ "234", "FO" }, .{ "238", "FK" }, .{ "239", "GS" },
    .{ "242", "FJ" }, .{ "246", "FI" }, .{ "248", "AX" }, .{ "249", "FR" }, .{ "250", "FR" },
    .{ "254", "GF" }, .{ "258", "PF" }, .{ "260", "TF" }, .{ "262", "DJ" }, .{ "266", "GA" },
    .{ "268", "GE" }, .{ "270", "GM" }, .{ "275", "PS" }, .{ "276", "DE" }, .{ "278", "DE" },
    .{ "280", "DE" }, .{ "288", "GH" }, .{ "292", "GI" }, .{ "296", "KI" }, .{ "300", "GR" },
    ...
    .{ "520", "NR" }, .{ "524", "NP" }, .{ "528", "NL" }, .{ "530", "CW" }, .{ "531", "CW" },
    .{ "532", "CW" }, .{ "533", "AW" }, .{ "534", "SX" }, .{ "535", "BQ" }, .{ "536", "SA" },
    .{ "540", "NC" }, .{ "548", "VU" }, .{ "554", "NZ" }, .{ "558", "NI" }, .{ "562", "NE" },
    .{ "566", "NG" }, .{ "570", "NU" }, .{ "574", "NF" }, .{ "578", "NO" }, .{ "580", "MP" },
    .{ "581", "UM" }, .{ "582", "FM" }, .{ "583", "FM" }, .{ "584", "MH" }, .{ "585", "PW" },
    .{ "586", "PK" }, .{ "591", "PA" }, .{ "598", "PG" }, .{ "600", "PY" }, .{ "604", "PE" },
    .{ "608", "PH" }, .{ "612", "PN" }, .{ "616", "PL" }, .{ "620", "PT" }, .{ "624", "GW" },
    .{ "626", "TL" }, .{ "630", "PR" }, .{ "634", "QA" }, .{ "638", "RE" }, .{ "642", "RO" },
    ...
    .{ "724", "ES" }, .{ "728", "SS" }, .{ "729", "SD" }, .{ "732", "EH" }, .{ "736", "SD" },
    ...
    .{ "807", "MK" }, .{ "810", "RU" }, .{ "818", "EG" }, .{ "826", "GB" }, .{ "830", "JE" },
    .{ "831", "GG" }, .{ "832", "JE" }, .{ "833", "IM" }, .{ "834", "TZ" }, .{ "840", "US" },
    .{ "850", "VI" }, .{ "854", "BF" }, .{ "858", "UY" }, .{ "860", "UZ" }, .{ "862", "VE" },
    .{ "876", "WF" }, .{ "882", "WS" }, .{ "886", "YE" }, .{ "887", "YE" }, .{ "890", "RS" },
    .{ "891", "RS" }, .{ "894", "ZM" }, .{ "960", "QN" }, .{ "962", "QP" }, .{ "963", "QQ" },
    .{ "964", "QR" }, .{ "965", "QS" }, .{ "966", "QT" }, .{ "967", "EU" }, .{ "968", "QV" },
    .{ "969", "QW" }, .{ "970", "QX" }, .{ "971", "QY" }, .{ "972", "QZ" },};
