...
pub const JsObject = struct {
    ...
    internal_kind: enum(u8) { none, regexp, bound_function, date, map, set, weakmap, weakset, promise, generator, proxy, array_buffer, typed_array, data_view, shared_array_buffer, module_namespace } = .none,
